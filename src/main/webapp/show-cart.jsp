			...
			<div class="content">
				...
				if(items==null || items.size()==0) {%>
					...
					<div class="gallery-articles-price">
						<p><b>TOTAL CARRITO: </b><%=0.0%> €</p>
						<div class="buttons">
							<button type="link" id="returnButton" class="login_button" onclick="location.href='show-articles'">Seguir comprando</button>
						</div>
					</div>
				<%}else{
					...
					<div class="gallery-articles-price">
						...
						<div class="buttons">
							<button type="link" id="returnButton" class="login_button" onclick="location.href='show-articles'">Seguir comprando</button>
							<button type="link" id="resetButton" class="login_button" onclick="location.href='empty-chart.jsp'">Vaciar carrito</button>
